...
export interface PipelineInput {
	...
	reconFanout?: boolean; // OPTIONAL recon breadth (default: false). When true, recon fans out into one sub-run per recommended tool. Resolved OUTSIDE workflow scope (from SHOR_RECON_FANOUT) and read here so the workflow stays deterministic.
