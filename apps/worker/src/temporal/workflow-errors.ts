...
const REMEDIATION_HINTS: Record<string, string> = {
	AuthenticationError:
		"Verify your API key (DEEPSEEK_API_KEY or ANTHROPIC_API_KEY) in .env is valid and not expired.",
	...
	ExecutionLimitError:
		"Agent exceeded maximum turns or budget. Review prompt complexity.",
};
